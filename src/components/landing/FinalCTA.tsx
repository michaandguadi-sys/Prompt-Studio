...
export const FinalCTA: React.FC<FinalCTAProps> = ({ serifFont, signedIn }) => {
  // Signed-in visitors go straight to the studio; new ones sign up and land
  // on /home — the same destination the hero CTA promises (consistent funnel).
    ...
    <section className="relative overflow-hidden px-6 py-32 text-center sm:py-40">
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-6">
          ...
          >
            {signedIn ? "Open the studio" : "Start for free now"}
